...
<head>
    <meta charset="UTF-8" />
    <title>Daftar PIC - APS SUPPORT</title>
...
<body>
    ...
    <div class="container py-5">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
            ...
            <form method="GET" action="{{ route('pic.index') }}" class="d-flex gap-2 mt-2 mt-md-0">
                    ...
                    @forelse ($pic as $index => $item)
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group" role="group" aria-label="Aksi Pic">
                                    <button
                                        ...
                                        data-nip="{{ $item->nip }}"
                                        data-notlp="{{ $item->notlp_pic }}"
                                        data-alamat="{{ $item->alamat_pic }}"
        ...
        <div class="mt-3 d-flex justify-content-between align-items-center">
            ...
            class="btn btn-pagination btn-sm @if($pic->onFirstPage()) disabled @endif"
            @if($pic->onFirstPage()) tabindex="-1" aria-disabled="true" @endif>
            &larr; Prev
            </a>
            ...
            class="btn btn-pagination btn-sm @if(!$pic->hasMorePages()) disabled @endif"
            @if(!$pic->hasMorePages()) tabindex="-1" aria-disabled="true" @endif>
            Next &rarr;
            </a>
        </div>
    </div>
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <form method="POST" action="{{ route('pic.store') }}" class="modal-content shadow-lg border-0 rounded-3">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama_pic" class="form-control shadow-sm" value="{{ old('nama_pic') }}" required />
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="notlp_pic" class="form-control shadow-sm" value="{{ old('notlp_pic') }}" required />
                        @error('notlp_pic') <small class="text-danger">{{ $message }}</small> @enderror
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Alamat</label>
                        <textarea name="alamat_pic" class="form-control shadow-sm" required>{{ old('alamat_pic') }}</textarea>
    ...
    <div class="modal fade" id="detailModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content shadow-lg border-0 rounded-3">
                ...
                <div class="modal-body">
                    <p><strong>Nama PIC:</strong> <span id="detailNama"></span></p>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <form method="POST" id="editForm" class="modal-content shadow-lg border-0 rounded-3">
                ...
                <div class="modal-body">
                    <input type="hidden" name="id_pic" id="edit_id_pic" />
                    <div class="mb-3">
                        <label class="form-label">Nama PIC</label>
                        <input type="text" name="nama_pic" id="edit_nama_pic" class="form-control shadow-sm" required />
                    </div>
                    <div class="mb-3">
                        <label class="form-label">NIP</label>
                    ...
                    <div class="mb-3">
                        <label class="form-label">Nomor Telepon</label>
                        <input type="text" name="notlp_pic" id="edit_notlp_pic" class="form-control shadow-sm" required />
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Alamat PIC</label>
                        <textarea name="alamat_pic" id="edit_alamat_pic" class="form-control shadow-sm" required></textarea>
                    </div>
                    <div>
                        <label class="form-label">Divisi</label>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <form method="POST" id="hapusForm" class="modal-content shadow-lg border-0 rounded-3">
                ...
                <div class="modal-body text-center">
                    <p class="mb-4">
                        Apakah Anda yakin ingin menghapus data <strong id="hapusNamaPic"></strong>?
                    </p>
    ...
    <script>
        ...
        editModal.addEventListener('show.bs.modal', event => {
            ...
            document.getElementById('edit_id_pic').value = id;
            document.getElementById('edit_nama_pic').value = nama;
            document.getElementById('edit_nip').value = nip;
            document.getElementById('edit_notlp_pic').value = notlp;
            document.getElementById('edit_alamat_pic').value = alamat;
        ...
        hapusModal.addEventListener('show.bs.modal', event => {
            ...
            document.getElementById('hapusNamaPic').textContent = nama;
        });
    </script>
</body>
</html>
