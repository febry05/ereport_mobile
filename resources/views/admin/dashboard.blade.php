...
<head>
    <meta charset="UTF-8">
    <title>Daftar Kerusakan - APS SUPPORT</title>
...
<body>
    ...
    <script>
        ...
        Livewire.on('show-selesai-modal', () => {
            const selesaiModal = new bootstrap.Modal(document.getElementById('selesaiModal'));
            selesaiModal.show();
        });

        window.addEventListener('close-modal', () => {
            ['addModal', 'editModal', 'hapusModal', 'selesaiModal'].forEach(id => {
